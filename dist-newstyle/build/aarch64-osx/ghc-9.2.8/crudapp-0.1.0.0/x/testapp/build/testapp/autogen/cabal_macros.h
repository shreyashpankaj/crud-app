...
/* package crudapp-0.1.0.0 */
#ifndef VERSION_crudapp
#define VERSION_crudapp "0.1.0.0"
#endif /* VERSION_crudapp */
#ifndef MIN_VERSION_crudapp
#define MIN_VERSION_crudapp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_crudapp */
...
/* package persistent-postgresql-2.13.5.2 */
#ifndef VERSION_persistent_postgresql
#define VERSION_persistent_postgresql "2.13.5.2"
...
#define CURRENT_COMPONENT_ID "crudapp-0.1.0.0-inplace-testapp"
